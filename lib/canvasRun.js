...
var CanvasRun = /** @class */function () {
    ...
    CanvasRun.prototype.init = function (_a) {
        var canvas = _a.canvas,
            ...
            gain = _b === void 0 ? 1 : _b,
            _c = _a.noNeedOff,
            noNeedOff = _c === void 0 ? false : _c,
            _d = _a.mounted,
            mounted = _d === void 0 ? function () {} : _d,
            _e = _a.created,
            created = _e === void 0 ? function () {} : _e;
    ...
    CanvasRun.prototype.compile = function (VDomTree) {
        return __awaiter(this, void 0, void 0, function () {
            var defaultEvent, events, canInheritAttr, openParentAttr, inherit, openAttr, _combination, addClass;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        openAttr = function openAttr(parent) {
                            if (!parent) return;
                            openParentAttr.forEach(function (i) {
                                if (parent.whiteSpace === 'nowrap') parent[i] = _this.computedWidth(parent)[i] || parent[i];
                            });
                        };
                        _combination = function combination(arr, parent) {
                            if (arr === void 0) {
                                arr = VDomTree;
                            }
                            if (parent === void 0) {
                                            ...
                                            _loop_1 = function _loop_1(i) {
                                                ...
                                                return __generator(this, function (_c) {
                                                    switch (_c.label) {
                                                        case 0:
                                                            // 注册class
                                                            arr[i].class && this_1.analysisString(arr[i].class).forEach(function (element) {
                                                                return addClass(element, arr[i]);
                                                            });
                                                            _a = arr[i].children && arr[i].children.length > 0;
                                                            if (!_a) return [3 /*break*/, 2];
                                                            return [4 /*yield*/, _combination(arr[i].children, arr[i])];
                                                        case 1:
                                                            _a = _c.sent();
                                                            _c.label = 2;
                                                        case 2:
                                                        ...
                                                        case 4:
                                                            ...
                                                            this_1.objectkeys(arr[i]).forEach(function (key) {
                                                                ...
                                                                if (typeof arr[i][key] === 'number') arr[i][key] *= _this.gain;
    ...
    CanvasRun.prototype.drwaRoundRect = function (_a) {
        var _b = _a.x,
            ...
            _g = _a.border,
            border = _g === void 0 ? '1rpx solid transparent' : _g;
    ...
    CanvasRun.prototype.drawFont = function (_a) {
        ...
        var fontSize = _a.fontSize,
            _b = _a.color,
            color = _b === void 0 ? '#000000' : _b,
            lineHeight = _a.lineHeight,
            maxLine = _a.maxLine,
            text = _a.text,
            _c = _a.textAlign,
            textAlign = _c === void 0 ? 'start' : _c,
            overText = _a.overText,
            overTextColor = _a.overTextColor,
    ...
    CanvasRun.prototype.drwaView = function (VCANVASDOM) {
        var backgroundImage = VCANVASDOM.backgroundImage,
            _a = VCANVASDOM.backgroundColor,
            backgroundColor = _a === void 0 ? 'transparent' : _a,
            x = VCANVASDOM.x,
            y = VCANVASDOM.y,
            w = VCANVASDOM.w,
            h = VCANVASDOM.h,
            text = VCANVASDOM.text,
            backgroundSize = VCANVASDOM.backgroundSize,
            backgroundPosition = VCANVASDOM.backgroundPosition,
            scale = VCANVASDOM.scale,
            opcity = VCANVASDOM.opcity,
            rotate = VCANVASDOM.rotate;
        ...
        ;
        this.ctx && backgroundImage && this.ctx.drawImage(backgroundImage, x, y, w, h);
    ...
    CanvasRun.prototype.viewWrap = function (VCANVASDOM) {
        this.ctx.save();
        // 粒子化单独渲染
        VCANVASDOM.particle ? this.getParticle(VCANVASDOM) : this.drwaView(VCANVASDOM);
        this.ctx.restore();
    };
    ;
    // 事件包裹器
    ...
    CanvasRun.prototype.warp = function (VCANVASDOM) {
        ...
        // 如果元素在canvas外则不绘制
        if (VCANVASDOM.x + w < 0 || VCANVASDOM.y + h < 0 || VCANVASDOM.x > w || VCANVASDOM.y > h) return;
    ...
    Object.defineProperty(CanvasRun.prototype, "getFile", {
        ...
        get: function get() {
            ...
            if (this.VDomTree && this.VDomTree.length > 0) {
                var combination_1 = function combination_1(arr, parent) {
                    if (arr === void 0) {
                        arr = _this.VDomTree;
                    }
                    if (parent === void 0) {
        ...
        this.eventStoreArea('touchend', {
            ...
            touchend: function touchend() {
                ...
                var run = function run() {
                    if (speed > 0) speed -= 10 * _this.gain;else speed += 10 * _this.gain;
                    parent.marginLeft = 1 * speed / 100 + fixUndefind(parent.marginLeft);
                    _this.draw();
                    if (Math.abs(speed) <= 10 * _this.gain) return;
